...
//    private static let TextFont: Font = .system(size: 11)
    ...
    private static let SegmentXPadding: CGFloat = 16/*16*/
    private static let SegmentYPadding: CGFloat = 3
    ...
    private func computeActiveSegmentHorizontalOffset() -> CGFloat {
        CGFloat(self.selection) * (self.segmentSize.width + SegmentedPicker.SegmentXPadding / 2)/*2*/
    }
